...
Visit **http://localhost:3000** to view the Safety_AI Dashboard.
...
For an in-depth breakdown of the exact mathematical formulas, loss functions (Focal Loss, Smooth L1), metrics (mAP, IoU), and architectural pipeline used to build Safety_AI, please refer to the comprehensive **`details.txt`** whitepaper included in the root of this repository.
